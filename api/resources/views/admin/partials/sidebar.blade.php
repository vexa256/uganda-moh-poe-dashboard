...
@php
    ...
    $reportsAll    = [
        // rpt-volume · Screening Volume & Risk Indicators — relaunched
        // 2026-05-18 against primary_screenings + secondary_screenings with a
        // past-7-days default window and full chart-export / explainer set.
        ...
        'rpt-suspected'        => $nav('rpt-suspected',        'Suspected Cases',
            'WHO-aligned case detection · top conditions · EOC distribution · weekly trend · outcomes',
            'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2H7a2 2 0 00-2 2v2',
            url('/admin/reports/rpt-suspected'), true),
        'rpt-geo'              => $nav('rpt-geo',              'Geographic Risk',
            'Origin & transit intelligence · choropleth · Sankey · endemic-zone overlay · border profiles',
            'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
            url('/admin/reports/rpt-geo'), true),
        'rpt-contact-tracing'  => $nav('rpt-contact-tracing',  'Contact Tracing',
            'Data-quality readiness · field completeness · screener leaderboard · POE radar · 30-day trend',
            'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
            url('/admin/reports/rpt-contact-tracing'), true),
        'rpt-registry'         => $nav('rpt-registry',         'Cases Registry',
            'PII-bearing notifiable cases · paginated · outcomes · EOC heatmap · POE comparison · masked phone/email by role',
            'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8',
            url('/admin/reports/rpt-registry'), true),
        'rpt-age-gender'       => $nav('rpt-age-gender',       'Age & Gender',
            'Pyramid · notifiable rate by age band · gender disparity · CFR by age · vulnerable cohorts (U5 / 65+)',
            'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
            url('/admin/reports/rpt-age-gender'), true),
        'rpt-symptom-exposure' => $nav('rpt-symptom-exposure', 'Symptom & Exposure',
            'Top-15 symptoms · co-occurrence heatmap · symptom × classification · exposure donut · outbreak tripwires',
            'M19 14l-7 7m0 0l-7-7m7 7V3',
            url('/admin/reports/rpt-symptom-exposure'), true),

        // Wave 2 — National Reports analytical surfaces (2026-04-26).
        'rpt-screening-outcomes' => $nav('rpt-screening-outcomes', 'Screening Outcomes',
            'Post-alert disposition · referral closure · onward facility outcome · 14-day follow-up · cycle-closure rate by POE / district / PHEOC',
            'M5 13l4 4L19 7',
            url('/admin/reports/rpt-screening-outcomes'), true),
        'rpt-suspected-disease-analytics' => $nav('rpt-suspected-disease-analytics', 'Suspected Disease Analytics',
            'Per-disease incidence · weekly trend · per-POE league · co-suspicion matrix · age × disease · outbreak tripwires',
            'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
            url('/admin/reports/rpt-suspected-disease-analytics'), true),
        'rpt-case-confirmation' => $nav('rpt-case-confirmation', 'Case Confirmation',
            'Suspected ↦ probable ↦ confirmed ↦ ruled-out · time-to-confirmation · lab pathway · false-positive rate',
            'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
            url('/admin/reports/rpt-case-confirmation'), true),
        'rpt-alert-acknowledgement' => $nav('rpt-alert-acknowledgement', 'Alert Acknowledgement',
            'Acknowledged vs unacknowledged · time-to-acknowledge · 7-1-7 compliance · breach reasons · responder leaderboard',
        ...
        'rpt-symptom-distribution' => $nav('rpt-symptom-distribution', 'Symptom Distribution',
            'Frequency · co-occurrence · symptom × disease · symptom × outcome · severity bands · seasonality',
            'M3 3v18h18M9 17V9m4 8V5m4 12v-7',
            url('/admin/reports/rpt-symptom-distribution'), true),
        'rpt-country-analytics' => $nav('rpt-country-analytics', 'Country Analytics',
            'National rollup · PHEOC league · district league · POE leaderboard · IHR readiness · 7-1-7 compliance map',
            'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
            url('/admin/reports/rpt-country-analytics'), true),

        // R8 — operational view for the counters (added 2026-05-18).
        'rpt-poe-operations' => $nav('rpt-poe-operations', 'PoE Operations',
            'Who is waiting now · hourly entries vs exits · processing time · entry-point league · screener productivity · daily volume trend',
