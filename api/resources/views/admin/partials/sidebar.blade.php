...
@php
    ...
    $menuSections = [
        ...
        [
            ...
            'items'   => [
                ...
                $nav('qr-confirmed',   'Confirmed Cases',
                    '#2 priority · lab pipeline by classification · confirmed diseases · IHR notifiables · default past 7 days',
                    'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
                    url('/admin/quick-reports/confirmed-cases'), true),
                $nav('qr-alert-db',    'Alert Database',
                    '#3 priority · every alert · status · owner · severity · IHR tier · case-file deep link',
                    'M4 6h16M4 10h16M4 14h10M4 18h10',
                    url('/admin/quick-reports/alert-database'), true),
                $nav('qr-alert-intel', 'Alert Analysis',
                    '#4 priority · pattern detection · risk × time · IHR tier exposure · false-positive %',
                    'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9',
                    url('/admin/quick-reports/alert-analysis'), true),
                $nav('qr-alert-out',   'Alert Outcomes',
                    '#5 priority · time-to-ack · time-to-close · % closed in 24 h · closure outcomes · reopen count',
                    'M5 13l4 4L19 7',
                    url('/admin/quick-reports/alert-outcomes'), true),
                $nav('qr-symptoms',    'Symptom Spread',
                    '#6 priority · top reported symptoms · red-flag cases highlighted · default past 7 days',
                    'M3 3v18h18M9 17V9m4 8V5m4 12v-7',
                    url('/admin/quick-reports/symptom-spread'), true),
                $nav('qr-poe',         'POE Analysis',
                    '#7 priority · entry-point activity · alert rate per POE · dark POEs surfaced · default past 7 days',
                    'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                    url('/admin/quick-reports/poe-analysis'), true),
                $nav('qr-country',     'Country Analysis',
                    '#8 priority · nationality · visited / transit · endemic-disease country flag · default past 7 days',
                    'M12 21v-1m0 0a8 8 0 100-16 8 8 0 000 16zM8 12h8M12 8v8',
                    url('/admin/quick-reports/country-analysis'), true),
                $nav('qr-daily',       'Daily Screening',
                    '#9 priority · today · yesterday · 7-day trend · busiest day · escalation rate · default past 7 days',
                    'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
                    url('/admin/quick-reports/daily-screening'), true),
                $nav('qr-volume',      'Screening Volume',
                    '#10 priority · primary vs secondary · gender mix · age bands · per-POE throughput · default past 7 days',
                    'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
                    url('/admin/quick-reports/screening-volume'), true),
                $nav('qr-users',       'User Analysis',
                    '#11 priority · officer activity · dormancy · workload distribution · top performer · default past 7 days',
                    'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
                    url('/admin/quick-reports/user-analysis'), true),
            ],
        ],
        ...
        */
        ...
        [
            'section' => 'Geography',
            'caption' => 'Reference hierarchy · countries · regions (PHEOCs) · districts · hospitals.',
            'icon'    => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
            'items'   => [
                $nav('geo-provinces', 'Regions',     'Regional PHEOCs · ref_provinces · cascades to PoEs on rename',                                          'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', url('/admin/geo/provinces'), true),
        ...
        // ── 12 · WORKFORCE ────────────────────────────────────────────────
        // 2026-05-20: collapsed from 3 items (Users / Roles / Assignments) to 1.
        // The new Workforce surface unifies people + role reference + atomic
        // add-person wizard. Legacy sub-routes still work for power users and
        // backward compat (PATCH /workforce/users/{id} etc.) — only the
        // navigation entry is consolidated.
        [
            'section' => 'Workforce',
            'caption' => 'People, roles, jurisdiction assignments — one surface.',
            'icon'    => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
            'items'   => [
                $nav('wf-home', 'Workforce', 'Unified view: people · roles · assignments · add-person wizard.', 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', url('/admin/workforce'), true),
            ],
        ],
